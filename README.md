...
```
git clone https://github.com/FewzanAbdulkerim/foundry_defi_StableCoin.git
...
- The latest version of openzeppelin-contracts has changes in the ERC20Mock file. To follow along with the course, you need to install version 5.3.0 which can be done by `forge install openzeppelin/openzeppelin-contracts@v5.3.0 --no-commit` instead of `forge install openzeppelin/openzeppelin-contracts --no-commit`
